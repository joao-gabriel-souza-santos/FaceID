...
public class TelaCadVisitante extends JFrame {
    // variaveis de ambiente
    private ImageIcon fundo = new ImageIcon(getClass().getResource("imagens\\CadVisitante.png"));
    private JFormattedTextField txtMotivo, txtCpf, txtTelefone;
    ...
    public TelaCadVisitante() {
        ...
        voltar.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                dispose();
                SelecionaCad adm = new SelecionaCad();
                adm.setVisible(true);
