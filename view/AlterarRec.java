...
public class AlterarRec extends JFrame {
                                ...
                                if (botaoCaptura.getModel().isPressed()) { // quando apertar o botão de captura
                                    ...
                                    if (amostras >= numAmostras) { // verifica se o total de fotos tiradas foi maior que
                                        ...
                                        try {
                                            ...
                                            JOptionPane.showMessageDialog(null, "Atualização efetuado", "Cadastro", 1);
                                        } catch (Exception e) {
                                            JOptionPane.showMessageDialog(null,
                                                    "Atualização não efetuado," + e.getMessage(), "Cadastro", 0);
                                        }
    ...
    public void inserirBanco() {
        try {
            if (this.codigo == 0 && motivo == null) { //verifica se a pessoa que esta alterando o cadastro é um aluno
            ...
            } else if (this.matricula == null && motivo == null) { //verifica se a pessoa que está alterando o cadastro é um funcionario
            ...
            } else if (this.motivo != null) { //verifica se a pessoa que está atualizando o cadastro é um visitante
